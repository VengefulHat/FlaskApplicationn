    ...
    try:
        ...
        def status_check(status, strona, i, aa):
            if status == 200:
                ...
                requests.put(alert_url + str(i), timeout=10, data=data)
                requests.put("http://212.32.248.106/v1/twice/api/" + str(i), timeout=10, data=data)
        ...
        if __name__ == '__main__':
            ...
            while True:
                ...
                for strona in baza_req_all.strony:
